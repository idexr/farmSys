...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">บันทึกข้อมูลสาเหตุไก่ตาย</h1>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">เพิ่มชื่อสาเหตุไก่ตาย</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">แก้ไขชื่อสาเหตุไก่ตาย</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#causeTable').DataTable({
                "ajax": {
                    "url": "get_deadType.php", // เรียกใช้ PHP ที่ดึงข้อมูล
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            return '<div class="action-buttons">' +
                                '<button class="edit-btn btn btn-warning shadow-sm" data-id="' + row.DeadTypeID + '" data-name="' + row.DeadTypeName + '"><i class="far fa-edit"></i></button>' +
                                ' <button class="del-btn btn btn-danger shadow-sm" data-id="' + row.DeadTypeID + '"><i class="far fa-trash-alt"></i></button>' +
                                '</div>';
                        }
                    }
                ]
            ...
            $('#saveAddBtn').on('click', function() {
                ...
                // ส่งข้อมูลด้วย AJAX
                $.ajax({
                    url: 'dead_add.php', // PHP ที่จัดการการเพิ่มข้อมูล
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        name: name
