            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">บันทึกข้อมูลคัดไข่ไก่</h1>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="chickenTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th class="five-col">รหัส</th>
                                                    <th class="ten-col">ฟาร์ม</th>
                                                    <th class="ten-col">เล้า</th>
                                                    <th class="ten-c0l">ใหญ่</th>
                                                    <th class="ten-col">เล็ก</th>
                                                    <th class="ten-col">ผิดรูป</th>
                                                    <th class="ten-col">สกปรก</th>
                                                    <th class="ten-col">บุบร้าว</th>
                                                    <th class="ten-col">เสียหาย</th>
