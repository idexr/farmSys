...
<body id="page-top">
    ...
    <!-- Bootstrap Modal สำหรับการย้าย -->
    <div class="modal fade" id="moveModalChicken" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">บันทึกข้อมูลไก่ย้ายเล้า</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span class="close" onclick="closeModal('moveModalChicken')">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="editForm">
                        ...
                        <div class="row">
                            <div class="col-sm-4 mt-1">
                                <label for="moveCoop">ย้ายไปเล้าที่</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="moveBtn">ย้าย</button>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        $('#Farm').append('<option value="' + value.FarmID + '">' + value.FarmName + '</option>');
                    });
                },
                error: function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // ลูปข้อมูลที่ได้จาก AJAX เพื่อเพิ่มลงใน dropdown
                    $.each(response, function(key, value) {
                        $('#Coop').append('<option value="' + value.CoopID + '">' + value.CoopName + '</option>');
                    });
                },
                error: function() {
                    alert('เกิดข้อผิดพลาดในการดึงข้อมูล');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // ลูปข้อมูลที่ได้จาก AJAX เพื่อเพิ่มลงใน dropdown
                    $.each(response, function(key, value) {
                        $('#moveCoop').append('<option value="' + value.CoopID + '">' + value.CoopName + '</option>');
                    });
                },
                error: function() {
                    alert('เกิดข้อผิดพลาดในการดึงข้อมูล');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // ลูปข้อมูลที่ได้จาก AJAX เพื่อเพิ่มลงใน dropdown
                    $.each(response, function(key, value) {
                        $('#Breed').append('<option value="' + value.breedID + '">' + value.breedName + '</option>');
                    });
                },
                error: function() {
                    alert('เกิดข้อผิดพลาดในการดึงข้อมูล');
            ...
            function calculateSum() {
                ...
                var num1 = parseFloat($('#moveChickenF').val()) || 0; // ถ้าไม่มีค่าให้เป็น 0
                var num2 = parseFloat($('#moveChickenM').val()) || 0;
            ...
            $('#moveChickenF, #moveChickenM').on('input', function() {
                calculateSum();
            });
            ...
            $('#moveBtn').on('click', function(e) {
                ...
                var formData = {
                    ...
                    chicken: $('#Breed').val(),
                    move: $('#moveCoop').val(),
                    chickenF: $('#moveChickenF').val(),
                    chickenM: $('#moveChickenM').val(),
                    inputDate: $('#Date').val()
                };
