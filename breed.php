...
<body id="page-top">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">เพิ่มชื่อพันธุ์ไก่</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="breedName">ชื่อพันธุ์ไก่</label>
                        <input type="text" class="form-control" id="breedName" placeholder="" required>
                    </div>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">แก้ไขชื่อพันธุ์ไก่</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="form-group">
                            <label for="editName">ชื่อพันธุ์ไก่</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            // เมื่อคลิกปุ่ม Edit
            $('#breedTable tbody').on('click', '.edit-btn', function() {
            ...
            $('#breedTable tbody').on('click', '.del-btn', function() {
                var id = $(this).data('id');
                Swal.fire({
                    title: 'Are you sure?',
